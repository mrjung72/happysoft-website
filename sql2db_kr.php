    ...
    <div class="container">
        ...
        <div class="features-grid">
            ...
            <div class="feature-card">
                <div class="feature-icon">📝</div>
                <h3>고급 SQL 파싱</h3>
                <p>주석 처리와 복잡한 구문을 지원하는 지능형 SQL 파싱으로 안정적인 마이그레이션 실행</p>
                <ul class="feature-details">
                    <li>다중 라인 주석 지원</li>
                    <li>복잡한 SQL 구문 파싱</li>
                    <li>오류 처리 및 복구</li>
            ...
            <div class="feature-card">
                <div class="feature-icon">🔄</div>
                <h3>동적 변수 시스템</h3>
                <p>런타임에 데이터를 추출하고 활용하는 유연한 변수 타입으로 동적 쿼리 생성</p>
                <ul class="feature-details">
                    <li>컬럼 식별 및 키-값 쌍 타입</li>
                    <li>런타임 데이터 추출</li>
                    <li>쿼리 내 변수 치환</li>
                </ul>
            </div>
            ...
            <div class="feature-card">
                <div class="feature-icon">🛡️</div>
                <h3>트랜잭션 관리</h3>
                <p>자동 롤백과 오류 복구를 통한 포괄적인 트랜잭션 지원으로 데이터 일관성 보장</p>
                <ul class="feature-details">
                    <li>자동 트랜잭션 관리</li>
                    <li>오류 시 롤백</li>
                    <li>격리 수준 구성</li>
        ...
        <div class="specs-grid">
            ...
            <div class="spec-category">
                ...
                <ul>
                    ...
                    <li><strong>연결 풀:</strong> 구성 가능한 풀 관리</li>
                    <li><strong>모니터링:</strong> 실시간 성능 메트릭</li>
                </ul>
            </div>
            ...
            <div class="spec-category">
                ...
                <ul>
                    ...
                    <li><strong>로깅:</strong> 5단계 로깅 시스템</li>
                </ul>
            </div>
    ...
    <div class="container">
        ...
        <div class="use-cases-grid">
            <div class="use-case-card">
                ...
                <h3>엔터프라이즈 데이터 마이그레이션</h3>
                <p>실시간 모니터링과 오류 처리를 통한 다양한 SQL Server 인스턴스 간의 대규모 데이터 마이그레이션</p>
                <ul>
                    <li>레거시 시스템 현대화</li>
                    <li>데이터베이스 통합</li>
                    <li>클라우드 마이그레이션 프로젝트</li>
                </ul>
            </div>
